...
| Production verification | *Verify P1-02 identity state* runs #1 and #2 — both succeeded |
| Authentication CTA fix | `6708f80b88341b2ef1ec30513c0c55696c5c451c` (PR #80), deploy run #104 |
