...
SemantIQ is a control plane for Microsoft Fabric. The confirmed repository baseline is:
...
6. `doc/reference/DATA_PROTECTION_SOVEREIGNTY_STANDARD.md`
7. `doc/context/CONTEXT_INDEX.md` and the context registers relevant to the change
8. Relevant entries in `doc/reference/SEMANTIQ_SRS_BASELINE.md`, `REQUIREMENT_TRACEABILITY.md`, `API_REGISTER.md`, and `HELP_TOPIC_INDEX.md`
9. For UI work, `doc/design-system/ui-and-ux-layout-template-shared.md`
10. For AI/conversational work, `doc/reference/AI_CONVERSATIONAL_TECHNOLOGY_GUIDE.md`
