...
| R1.4 | Gate 4 | Data Protection, Sovereignty & PDPA | `IN_PROGRESS (R1.4a and R1.4b accepted)` | Phrase not yet set. **The GATE is not complete** - acceptance so far covers batches R1.4a and R1.4b only. R1.4c is NOT STARTED | ADM-013 to ADM-016, plus the three PDPA obligations DEC-002 traced and the required privacy contact (SEC-DEC-043, now resolved). **Plan approved 24 August 2026**: `doc/execution/R1.4-GATE-4-DATA-PROTECTION-PDPA-PLAN.md`. All thirteen decisions recorded as SEC-DEC-062 to SEC-DEC-072 and DEC-003. Building as three PRs: **R1.4a** profiles and privacy contact - **ACCEPTED 24 August 2026** in the product owner's own words, "I formally accept R1.4a", after they verified it on the live deployment themselves (evidence in `ADMIN-FOUNDATION-RELEASE-1-VERIFICATION.md` section 14); **R1.4b** auditor capability, sovereignty exceptions, per-category retention, audit log - **ACCEPTED 24 August 2026** in the product owner's own words, "I formally accept R1.4b", after they verified all three screens on the live deployment themselves. Shipped as PR #26 (`f920f41`) plus PR #27 (`c5974ab`), which repaired a production migration that MySQL refused and added a permanent identifier-length guard. Evidence in `ADMIN-FOUNDATION-RELEASE-1-VERIFICATION.md` section 15; decisions DEC-004, DEC-005 and SEC-DEC-078; **R1.4c** privacy requests, breach register, governance overview - **NOT STARTED**. Each needs its own PR, CI, review, deployment verification and approval before the next starts |
